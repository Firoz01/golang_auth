...
const GRPC_TIMEOUT_SECS = 50
const ACCESSTOKEN_VALIDITY_MINS = 1
const REFRESHTOKEN_VALIDITY_MINS = 30
...
type (
	...
	Config struct {
		...
		PassPhrase       string `env:"PASS_PHRASE" mapstructure:"PASS_PHRASE"`
		UsersServiceGrpc string `env:"USERS_SERVICE_GRPC_ADDRESS" mapstructure:"USERS_SERVICE_GRPC_ADDRESS"`
	...
	Redis struct {
		...
		RedisUserName string `env:"REDIS_USER_NAME"`
